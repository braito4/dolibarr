...
-- Multiple semantic rows may connect the same pair (requirements in different
-- roles, generic links and split assignments), so this lookup index is not unique.
